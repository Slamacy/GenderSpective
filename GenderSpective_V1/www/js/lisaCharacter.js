...
function lisaCharacter() {
    ...
    lisaConversationUpdate();
    
    function lisaConversationUpdate() {
        console.log(lisaOver);
        $("#speechText").html(response);
        $("#option1").html(option1);console.log(lisaOver);
        ...
        if(gender === "male") {
            $("#option1").click(function() {
                if($(this).html() === "<h2>[exit]</h2>") {
                ...
                else if($(this).html() === "<h2>Can I borrow a pen?</h2>") {
                    ...
                    response = "<h1>Prove it! It's not rude if it's true!</h1>";
                    ...
                    option1 = "<h2>You have received the item! [exit]</h2>";
                    option2 = "";
                    option3 = "";
